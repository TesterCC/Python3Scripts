...
# ref: https://zhuanlan.zhihu.com/p/23064000
# 可以半人工识别解决验证码问题，亲测
# 本地人工识别验证码：scp -r server_login_username@yoursever_ip:/data/demo/auto_post_event_v2/captcha.jpeg captacha.jpeg && open captacha.jpeg
# 拓展：如果会自己训练模型，可以针对这个类型的图形训练一个识别库
...
if __name__ == "__main__":
    ...
    weibo = WeiBoLogin()
    weibo.login("your_weibo_username", "your_weibo_password")