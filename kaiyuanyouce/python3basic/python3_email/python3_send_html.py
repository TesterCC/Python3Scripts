...
def send_email_html():
    ...
    # 发送内容构建
    # html标识发送内容为文本格式
    msg = MIMEText("<p>微信公众号号：fullstackpentest</p><a href='http://www.fullstackpentest.com'>Python全栈研习社</a>",
                   "html",
                   "utf-8")
    ...
    # 构建邮件标题
    msg["Subject"] = Header("[Python全栈研习社]_FullstackPentest_html测试", "utf-8")
