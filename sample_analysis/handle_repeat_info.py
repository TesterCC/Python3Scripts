...
print("poc.json count: ", len(data))
# print(type(data))
# print(data)

sample_char = "url=/agent/winDownloader method=GET args=k=d06db9752e878c0b7c8058d8d335af969ebda2b8&group=2&protocol=0"
...
poc_file_path = r'E:\00working_file\dev_docs\ARAS\sample_20210201\poc'
...
files = []
new_poc_file_path = r'E:\00working_file\dev_docs\ARAS\sample_20210201\poc_v1\poc'
for root, dirs, files in os.walk(poc_file_path):
