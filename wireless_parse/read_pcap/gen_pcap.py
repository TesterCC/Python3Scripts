...
pktdump = PcapWriter("output.pcap", append=True, sync=True)
...
def send_packet_demo(host, port, filename, key=None, BUFFER_SIZE=1426):
    ...
    # todo no need to notice receive   # receiver first receive 0x01, then receive 0x02
    # read file
