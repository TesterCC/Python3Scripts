...
# packet_list = scapy.all.rdpcap('udp9999.pcap')  # plain textwrap no use
# packet_list = scapy.all.rdpcap('20230705-100.3to100.6.pcap')  # cipher text  testcase0
# packet_list = scapy.all.rdpcap('0923testsimpleudp.pcap')  # cipher text    testcase1
packet_list = scapy.all.rdpcap('0923testalludp.pcap')  # cipher text   # A udp aes to C
