...
def parse_packet(data):
    ...
    data = ip_tuple[-1]
    udp_header_len = 8
    udp_data_len = len(data) - udp_header_len
    udp_fmt = '!HH%ds' % udp_data_len
    udp_tuple = struct.unpack(udp_fmt, data)  # 有问题，要参考下代码模板

    packet['sport'] = udp_tuple[0]
    packet['dport'] = udp_tuple[1]
    packet['udp_data'] = udp_tuple[2]
    packet['udp_data_len'] = udp_data_len
